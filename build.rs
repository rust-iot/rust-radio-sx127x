...
fn main() {
    ...
    // directory examples/memoryMaps/xxx/  where xxx is replaced by an one of
    ...
    // For example,   examples/memoryMaps/STM32F401/memory.x
    ...
    let d = "examples/memoryMaps/".to_owned();
    for m in &mcus {
