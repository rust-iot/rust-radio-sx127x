// SETUP() TEMPORARILY DISABLED. ATTEMPT BUILD ONLY WITH
...
// this might work when stm32*_hal supplying spi all use same version of embedded-hal
...
use stm32f1xx_hal::{prelude::*,   
    ...
    //fn setup() ->  Sx127x<SpiWrapper<Spi<SPI1, Spi1NoRemap,
...
use stm32f3xx_hal::{prelude::*, 
    ...
    //fn setup() ->  Sx127x<SpiWrapper<Spi<SPI1, 
...
use stm32f4xx_hal::{prelude::*,  
                    ...
                    delay::Delay,
                    time::MegaHertz,
                    //  following are be needed to define exact type 
...
// may be better to explicitly define it as follows. This also require extra lines in above use.

    type LoraType = Sx127x<SpiWrapper<Spi<SPI1, 
...
//`radio_sx127x::Sx127x<SpiWrapper<stm32f4xx_hal::spi::Spi<stm32f4::stm32f411::SPI1, 
...
// stm32f4xx_hal::gpio::gpioa::PA0<stm32f4xx_hal::gpio::Output<stm32f4xx_hal::gpio::PushPull>>, 
// core::convert::Infallible, stm32f4xx_hal::delay::Delay, stm32f4xx_hal::delay::Delay>, 
// stm32f4xx_hal::spi::Error, core::convert::Infallible, stm32f4xx_hal::delay::Delay>`


//   ***********  setup CODE TEMOPORARILY MOVED FROM HERE TO MAIN ****************
...
use stm32f7xx_hal::{prelude::*,  
    ...
    //fn setup() -> Sx127x<SpiWrapper<Spi<SPI1,impl Pins<SPI1>, Enabled<u8>>,  Error, 
    //               PA1<Output<PushPull>>,  PB8<Input<Floating>>,  PB9<Input<Floating>>,  PA0<Output<PushPull>>, 
    //               core::convert::Infallible,  Delay>,  Error, core::convert::Infallible> {
...
use stm32l0xx_hal::{prelude::*,  
    ...
    //fn setup() -> Sx127x<SpiWrapper<Spi<SPI1,impl Pins<SPI1>>, Error, 
    //               PA1<Output<PushPull>>,  PB8<Input<Floating>>,  PB9<Input<Floating>>,  PA0<Output<PushPull>>, 
