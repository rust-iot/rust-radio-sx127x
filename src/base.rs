...
pub trait Hal<CommsError, PinError> {
    ...
    fn reg_write(&mut self, reg: u8, data: &[u8]) -> Result<(), Error<CommsError, PinError>>;
    /// Read from the specified register
    fn reg_read(&mut self, reg: u8, data: &mut [u8]) -> Result<(), Error<CommsError, PinError>>;

    /// Write to the specified FIFO buffer
    fn buff_write(&mut self, data: &[u8]) -> Result<(), Error<CommsError, PinError>>;
    /// Read from the specified FIFO buffer
    fn buff_read(&mut self, data: &mut [u8]) -> Result<(), Error<CommsError, PinError>>;
}
...
{    
    ...
    /// Read from the specified register
    fn reg_read<'a>(&mut self, reg: u8, data: &mut [u8]) -> Result<(), Error<CommsError, PinError>> {
        // Setup register read
    ...
    fn buff_read<'a>(&mut self, data: &mut [u8]) -> Result<(), Error<CommsError, PinError>> {
